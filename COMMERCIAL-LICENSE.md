...
### 2. Alcance por modalidad

#### A. Suscripción por local
- Pago mensual o anual por restaurante/local.
- Incluye actualizaciones, soporte básico y alojamiento guiado/asesorado.
- Queda prohibido redistribuir o revender el servicio como propio sin acuerdo expreso.

#### B. Compra única
- Pago único por local.
- Incluye 1 año de actualizaciones y soporte básico.
- Renovación anual opcional.
- Queda prohibido sublicenciar el producto a terceros sin autorización.
...
El código base y arquitectura siguen siendo propiedad de Michel-Macias, salvo pacto contrario por escrito.

### 5. Garantía
Se entrega el producto tal cual, sin garantía de resultados económicos ni operativos.
